...
const ValidationModal: React.FC<ValidationModalProps> = ({
  ...
  // Check for previous validation stored in invoice
  const previousErrors = invoice.zatca?.errors || [];
  const previousWarnings = invoice.zatca?.warnings || [];
  const hasPreviousErrors = previousErrors.length > 0 || previousWarnings.length > 0;
  const lastValidatedAt = invoice.zatca?.lastValidatedAt;
  const previousValidationStatus = invoice.zatca?.validationStatus;
          ...
          <div className="px-6 py-4 max-h-96 overflow-y-auto">
            ...
            {isValidating && (
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <p className="text-gray-600 font-medium">Validating invoice...</p>
            ...
            {showEmptyState && (
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <p className="text-sm text-gray-500 mt-2 text-center">
                  Click the button below to validate this invoice against ZATCA rules before submitting.
                </p>
              </div>
            )}
            ...
            {showPreviouslyValidated && (
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <p className="text-sm text-gray-500 mt-1 text-center">
                  This invoice was validated successfully and is ready to submit to ZATCA
                </p>
                {lastValidatedAt && (
            ...
            {showPreviousErrors && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600 mt-4">
                  Click &quot;Validate Again&quot; to re-check this invoice.
                </p>
              </div>
            )}
