...
const statusConfig = {
  ...
  warning: { label: 'Warning', icon: AlertTriangle, color: 'bg-blue-100 text-blue-800' },
};
                ...
                <tr key={activity.id} className="hover:bg-gray-50 transition-colors duration-150">
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="h-8 w-8 bg-gradient-to-br from-primary-400 via-blue-400 to-indigo-500 rounded-full flex items-center justify-center text-white font-medium text-xs">
