...
const statusConfig = {
  ...
  pending: { label: 'Pending', icon: Clock, color: 'bg-blue-100 text-blue-800' }
};
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border z-10">
                  <div className="p-4 space-y-4">
                    ...
                    <div className="flex space-x-2 pt-2">
                      <button className="flex-1 px-3 py-2 bg-gradient-to-r from-primary via-blue-600 to-indigo-700 text-white rounded-lg text-sm font-medium hover:from-indigo-700 hover:via-blue-600 hover:to-primary transition-all duration-500">
                        Apply
                      </button>
                ...
                <tr key={user.id} className="hover:bg-gray-50 transition-colors duration-150">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="h-10 w-10 bg-gradient-to-br from-primary-400 via-blue-400 to-indigo-500 rounded-full flex items-center justify-center text-white font-medium text-sm">
