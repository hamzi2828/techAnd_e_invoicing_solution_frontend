    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <Loader className="h-8 w-8 animate-spin text-lime-600 mx-auto mb-4" />
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            disabled={isSubmitting}
            className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-lime-500 to-yellow-500 text-white rounded-lg text-sm font-medium hover:from-lime-600 hover:to-yellow-600 transition-all duration-300 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
              <>
